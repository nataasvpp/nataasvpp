...
#ifndef included_vcdp_geneve_packet_h
#define included_vcdp_geneve_packet_h
 ...
 */
static inline u32
vcdp_get_geneve_vni (geneve_header_t * h)
{
...
static inline u32
vcdp_get_geneve_vni_network_order (geneve_header_t * h)
{
  return (h->vni_rsvd & clib_net_to_host_u32 (GENEVE_VNI_MASK));
}

static inline void
vcdp_set_geneve_vni (geneve_header_t * h, u32 vni)
{
...
static inline u8
vcdp_get_geneve_version (geneve_header_t * h)
{
  return ((h->first_word & GENEVE_VERSION_MASK) >> GENEVE_VERSION_SHIFT);
}

static inline void
vcdp_set_geneve_version (geneve_header_t * h, u8 version)
{
...
static inline u8
vcdp_get_geneve_options_len (geneve_header_t * h)
{
  return ((h->first_word & GENEVE_OPTLEN_MASK) >> GENEVE_OPTLEN_SHIFT);
}

static inline void
vcdp_set_geneve_options_len (geneve_header_t * h, u8 len)
{
...
static inline u8
vcdp_get_geneve_oamframe_bit (geneve_header_t * h)
{
  return ((h->first_word & GENEVE_O_BIT_MASK) >> GENEVE_O_BIT_SHIFT);
}

static inline void
vcdp_set_geneve_oamframe_bit (geneve_header_t * h, u8 oam)
{
...
static inline u8
vcdp_get_geneve_critical_bit (geneve_header_t * h)
{
  return ((h->first_word & GENEVE_C_BIT_MASK) >> GENEVE_C_BIT_SHIFT);
}

static inline void
vcdp_set_geneve_critical_bit (geneve_header_t * h, u8 critical_opts)
{
...
static inline u16
vcdp_get_geneve_protocol (geneve_header_t * h)
{
  return (h->first_word & GENEVE_PROTOCOL_MASK);
}

static inline void
vcdp_set_geneve_protocol (geneve_header_t * h, u16 protocol)
{
...
static inline void
vcdp_geneve_hdr_1word_ntoh (geneve_header_t * h)
{
  h->first_word = clib_net_to_host_u32 (h->first_word);
}

static inline void
vcdp_geneve_hdr_1word_hton (geneve_header_t * h)
{
