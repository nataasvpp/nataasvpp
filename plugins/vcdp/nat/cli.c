...
VLIB_CLI_COMMAND (vcdp_nat_alloc_pool_add_del, static) = {
  .path = "vcdp nat alloc-pool",
  .short_help = "vcdp nat alloc-pool [add|del] <alloc-pool-id> <ip-addr>+",
  .function = vcdp_nat_alloc_pool_add_del_fn,
};
