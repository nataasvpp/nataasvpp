...
#define vcdp_log_err(...) \
  vlib_log(VLIB_LOG_LEVEL_ERR, vcdp_tunnel_main.log_default, __VA_ARGS__)
#define vcdp_log_warn(...) \
  vlib_log(VLIB_LOG_LEVEL_WARNING, vcdp_tunnel_main.log_default, __VA_ARGS__)
#define vcdp_log_notice(...) \
  vlib_log(VLIB_LOG_LEVEL_NOTICE, vcdp_tunnel_main.log_default, __VA_ARGS__)
#define vcdp_log_info(...) \
  vlib_log(VLIB_LOG_LEVEL_INFO, vcdp_tunnel_main.log_default, __VA_ARGS__)
...
int vcdp_tunnel_create(char *tunnel_id, u32 tenant, vcdp_tunnel_method_t method,
                   ...
                   u16 mtu);
int vcdp_tunnel_lookup(u32 context_id, ip4_address_t src, ip4_address_t dst,
