...
main(int argc, char **argv)
{
  ...
  int rv = vcdp_tunnel_add("tunnel1", 1, VL_API_VCDP_TUNNEL_VXLAN_DUMMY_L2, &src, &dst, 0, 4278, 0, 0, 0);
  ...
  rv = vcdp_tunnel_add("tunnel2", 1, VL_API_VCDP_TUNNEL_VXLAN_DUMMY_L2, &src, &dst, 0, 4278, 0, 0, 0);

  assert(rv == -1 && "creating duplicate tunnel");

  rv = vcdp_tunnel_add("tunnel2", 1, VL_API_VCDP_TUNNEL_VXLAN_DUMMY_L2, &src, &dst, 0, 4279, 0, 0, 0);
